          ...
          <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
              ...
              <p className="mt-8 text-lg font-medium text-pretty text-amber-900 sm:text-xl/8">
                Com mais de 30 anos de experiência, a Dra. Luciana Plutarco é uma referência em medicina estética e saúde da mulher. Sua clínica oferece tratamentos personalizados para atender às necessidades de cada paciente, sempre com foco na segurança e bem-estar.
              </p>
